...
def calculate_parking_fee(duration, vehicle_type):
    if vehicle_type.lower() == "xe máy":
        if duration < 5:
            return 5
        elif duration < 12:
            return 12
        else:
            return (duration // 24) * 25 + (12 if duration % 24 > 0 else 0)
    else:
        if duration < 5:
            return 10
        elif duration < 12:
            ...
            return (duration // 24) * 40 + (25 if duration % 24 > 0 else 0)
